...
describe('v2alpha1.TpuClient', () => {
    ...
    describe('getNode', () => {
        it('invokes getNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNodeRequest', ['name']);
    ...
    describe('getAcceleratorType', () => {
        it('invokes getAcceleratorType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAcceleratorTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRuntimeVersion', () => {
        it('invokes getRuntimeVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRuntimeVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getGuestAttributes', () => {
        it('invokes getGuestAttributes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetGuestAttributesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createNode', () => {
        it('invokes createNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateNodeRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteNode', () => {
        it('invokes deleteNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopNode', () => {
        it('invokes stopNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('startNode', () => {
        it('invokes startNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateNode', () => {
        it('invokes updateNode without error', async () => {
            ...
            request.node ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateNodeRequest', ['node', 'name']);
    ...
    describe('listNodes', () => {
        it('invokes listNodes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNodesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listAcceleratorTypes', () => {
        it('invokes listAcceleratorTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAcceleratorTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listRuntimeVersions', () => {
        it('invokes listRuntimeVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRuntimeVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
